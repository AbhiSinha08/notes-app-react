...
const NewNote = (props) => {
    ...
    return (
        <div className='flex flex-col mx-auto rounded-md my-2 border-gray-600 border-[1.5px] px-4 py-1 w-[50%] focus-within:border-blue-500 focus-within:border-2'>
            ...
            className='mt-1 focus:outline-none w-full mb-4 h-14' />
            <hr />
